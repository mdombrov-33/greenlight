...
// Envelope is a technique that transforms top level object into a keyed one. For example, with envelope all movie data that we sent will be accessible via "movie" key.
type envelope map[string]any

func (app *application) writeJSON(w http.ResponseWriter, status int, data envelope, headers http.Header) error {
	// MarshalIndent is a little bit slower than Marshal. If operating in sensitive environments stick to Marshal.
